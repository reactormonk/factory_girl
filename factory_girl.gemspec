...
Gem::Specification.new do |s|
  ...
  s.description = %q{factory_girl provides a framework and DSL for defining and
                     ...
                     all-around easier to work with than fixtures.  This version compatible with
                     DataMapper}
  ...
  s.summary = %q{factory_girl provides a framework and DSL for defining and using model instance factories. This Version compatible with DataMapper.}
